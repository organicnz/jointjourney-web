  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 pb-16 min-h-screen relative text-gray-900 dark:text-gray-100 mt-2">
      ...
      <aside className="w-full md:w-64 flex-shrink-0 relative z-20">
        <div className="sticky top-24 bg-white/40 dark:bg-gray-900/40 backdrop-blur-3xl border border-white/60 dark:border-gray-800/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] rounded-3xl p-4 flex flex-col gap-2 max-h-[calc(100vh-8rem)] overflow-y-auto no-scrollbar">
